...
export type GithubRepoData = MinimalRepository[];
 ...
 * How the author is associated with the repository.
 */
export type AuthorAssociation1 =
  | "COLLABORATOR"
  | "CONTRIBUTOR"
  | "FIRST_TIMER"
  | "FIRST_TIME_CONTRIBUTOR"
...
export interface IssueComment {
  ...
  body_html?: string
  html_url: string
  user: null | SimpleUser8
  created_at: string
  updated_at: string
  issue_url: string
  author_association: AuthorAssociation1
  performed_via_github_app?: null | GitHubApp1
  reactions?: ReactionRollup1
  [k: string]: unknown
}
/**
 * A GitHub user.
...
export interface ReactionRollup1 {
  url: string
  total_count: number
  "+1": number
  "-1": number
